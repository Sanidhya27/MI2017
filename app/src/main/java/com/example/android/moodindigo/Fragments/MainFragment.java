...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String mi_number=inBundle.get("mi number").toString();

        Bundle bundle=new Bundle();
        bundle.putString("name",name);
        bundle.putString("imageUrl",imageUrl);
        bundle.putString("mi number",mi_number);
        ...
        */
        ...
        upcomingEventsFragment2 = new UpcomingEventsFragment();
        upcomingEventsFragment2.setArguments(bundle);

        Log.i("name1",imageUrl);

        adapter.addFragment(upcomingEventsFragment);
        adapter.addFragment(upcomingEventsFragment2);
